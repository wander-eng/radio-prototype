...
| Dash | Cancela a animação de ataque em andamento; duração 0.15s; cooldown 0.4s | Abre 0.2s de invulnerabilidade e 1s de contra-ataque; `timeScale` 0.5 por 150ms só ativa quando uma ameaça realmente colide na janela de invulnerabilidade e é esquivada | Trajetória em arco; atinge múltiplos alvos no caminho |
| Dano especial | +5% por hit consecutivo, cap em +30%; reseta ao errar, 2s sem acertar, ou trocar de estação | Contra-ataque: o próximo hit bem-sucedido dentro de 1s após o dash causa dano x1.5; esquiva confirmada renova a janela sem acumular bônus | Cada hit atinge todos os alvos num raio de 1.5 unidades ao redor |
